...
namespace TimeSeriesModel
{
    public partial class TrainingResult : Form
    {
        ...
        public void ShowDialog()
        {
            ...
            //chart2.Series["MAE"].Color = System.Drawing.Color.Red;
            //for (int i = 0; i < m_ValidateMAErrorList.Count; i++)
            //{
            //    chart2.Series["MAE"].Points.AddXY(i + 1, m_ValidateMAErrorList.ElementAt(i));
            //}

            labelProcessedEpoches.Text = Convert.ToString(m_ProcessEpoches);
            labelMAE.Text = Convert.ToString(m_MAE);
            labelValidateMAE.Text = Convert.ToString(m_ValidateMAE);
            base.ShowDialog();
        }
